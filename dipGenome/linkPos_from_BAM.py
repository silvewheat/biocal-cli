...
def main(inbam1: str = typer.Option(..., help="BAM from ref1"),
         ...
         outfile: str = typer.Option(..., help="output link file from ref1 to ref2"),
         savematrix: str = typer.Option(None, help="save link matrix to this directory")):
...
#        matrix_to_pos(ctg_hap1, matrix_R2T, outfile, rnames_hap2, offsets_hap2, chrom2offset_hap2)
